      ...
      <aside className={`sidebar ${isSidebarOpen ? 'mobile-open' : ''}`}>
        ...
        <div style={{ position: 'absolute', bottom: '2rem', left: '2rem', right: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
           <div className="glass-panel" style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>{user?.role === 'admin' ? t('administrator') : t('customer')}</p>
              </div>
            </div>
           ...
           <button 
            ...
            style={{ padding: '0.5rem', borderRadius: '0.5rem', background: 'rgba(255,255,255,0.05)', border: '1px solid var(--border-color)', color: 'var(--text-muted)', cursor: 'pointer', fontSize: '0.75rem' }}
           >
            {t('switchTo')} {userRole === 'admin' ? t('customer') : t('administrator')}
           </button>
        </div>
      </aside>
